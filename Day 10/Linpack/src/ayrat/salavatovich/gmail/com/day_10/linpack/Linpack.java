...
public class Linpack {
	...
	public String run_benchmark() {
		...
		return formatResultBenchmark(result);
	}

	private String formatResultBenchmark(HashMap<String, Double> result) {
	...
	private final double matgen(double a[][], int lda, int n, double b[]) {
		double norma;
		int init, i, j;
	 ...
	 */
	private final int dgefa(double a[][], int lda, int n, int ipvt[]) {
		double[] col_k, col_j;
		double t;
		int j, k, kp1, l, nm1;
		int info;
	 ...
	 * blas daxpy,ddot
	 */
	private final void dgesl(double a[][], int lda, int n, int ipvt[],
			double b[], int job) {
		double t;
		int k, kb, l, nm1, kp1;
	 ...
	 */
	private final void daxpy(int n, double da, double dx[], int dx_off,
			int incx, double dy[], int dy_off, int incy) {
		int i, ix, iy;
	 ...
	 */
	private final double ddot(int n, double dx[], int dx_off, int incx,
	 ...
	 */
	private final void dscal(int n, double da, double dx[], int dx_off, int incx) {
		int i, nincx;
	 ...
	 * linpack, 3/11/78.
	 */
	private final int idamax(int n, double dx[], int dx_off, int incx) {
		double dmax, dtemp;
		int i, ix, itemp = 0;
	 ...
	 */
	private final double epslon(double x) {
		double a, b, c, eps;
	 ...
	 */
	private final void dmxpy(int n1, double y[], int n2, int ldm, double x[],
			double m[][]) {
		int j, i;
