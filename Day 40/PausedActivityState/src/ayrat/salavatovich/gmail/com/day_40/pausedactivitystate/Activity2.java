package ayrat.salavatovich.gmail.com.day_40.pausedactivitystate;
...
public class Activity2 extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		button = (Button) findViewById(R.id.buttonOfActivity2);
	...
	private void showToast(final String activity) {
		Toast.makeText(
				...
				getString(R.string.toast_text,
						getString(R.string.name_class_activity_2), activity),
